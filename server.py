...
class TCPServer:
    ...
    def handle_client(self, connection):
        try:
            ...
            self.processor.save_file(connection, input_file_path, file_size, self.chunk_size)
            connection.sendall(bytes([0x00]))  # Success

            output_file_path = self.process_file(json_file, input_file_path, file_name)
    ...
    def process_file(self, json_file, input_file_path, file_name):
    ...
    def send_file(self, connection, output_file_path):
        ...
        with open(output_file_path, 'rb') as f:
            ...
            header = self.build_header(len(json_bytes), media_type_length, file_size)
