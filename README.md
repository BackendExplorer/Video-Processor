...
1. **課題意識**
   ...
    動画処理やファイル転送の仕組みを自作して、動画処理や、通信処理、UIの構築を学ぶため

2. **解決アプローチ**

   `TCPソケット通信`、`FFmpeg制御`、`独自プロトコル`、`Streamlit UI` によって
    メディア変換サービスを構築

3. **得られた学び**

   ファイルの送受信や動画の加工がどう動いているかを仕組みから学び、役割ごとにわかりやすく整理したコードや、他者にわかりやすく伝えるためのREADMEの作成を経験
...
<img width="789" alt="スクリーンショット 2025-05-12 12 40 33" src="https://github.com/user-attachments/assets/6cec89a0-7704-45dd-b9b3-e645251b40c5" />
