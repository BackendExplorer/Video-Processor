...
flowchart TD
    ...
    Start --> ファイル選択 --> オプション選択 --> アップロード開始 --> アップロード成功
    アップロード成功 -- Yes --> サーバ受信 --> 加工処理 --> 加工成功
    アップロード成功 -- No --> エラー処理1 --> End

    加工成功 -- Yes --> 加工完了 --> ダウンロード開始 --> ダウンロード成功
    加工成功 -- No --> エラー処理2 --> End

    ダウンロード成功 -- Yes --> 保存完了 --> End
    ダウンロード成功 -- No --> エラー処理3 --> End
```
